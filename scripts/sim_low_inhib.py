...
dirname = "../results/low_inhib/" + "_".join([p + str(v) for (p,v) in zip(param_df.parameter, param_df.value)])
...
for i in range(trials):
    ...
    # plt.imshow(J)
        ...
        with open("../results/low_inhib/spikes_h={}.pkl".format(h), "wb") as file:
        ...
        for region in index_dict:
            if (region == "CA1E" )or (region == "CA1P" ):
                ...
                rates = [rate(spktimes = spktimes, neuron = i,  tstop = tstop) for i in neurons]
