...
for g in gs:
    ...
    for h in [1,2]:
        ...
        CA1_internal.append(CA1_internal_cov_offdiag(J = J_small, r = y_q_red, b = b_iso, N = cells_per_region)[0,0])
        CA1_inherited.append(CA1_inherited_cov(J = J_small, r = y_q_red, b = b_iso, N = cells_per_region)[0,0])
        CA3.append(CA3_internal_cov(J = J_small, r = y_q_red, b = b_iso, N = cells_per_region)[0,0])

        from_CA3I.append(CA3_E_from_I(J = J_small, r = y_q_red, b = b_iso, N = cells_per_region))
        from_CA3E.append(CA3_E_from_E(J = J_small, r = y_q_red, b = b_iso, N = cells_per_region)) 
        from_CA3N.append(CA3_E_from_N(J = J_small, r = y_q_red, b = b_iso, N = cells_per_region))  
...
with open("../results/compare_inhib/decomposition_df.pkl", "wb") as f:
...
with open("../results/compare_inhib/raw_theory_df.pkl", "wb") as f:
...
with open("../results/compare_inhib/theory_df.pkl", "wb") as f:
    pkl.dump(obj = df, file = f)
