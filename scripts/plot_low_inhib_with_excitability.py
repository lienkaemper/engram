...
neurons = range(270)
tstop = 250
with open("../results/with_excitability/spikes_h={}.pkl".format(1.0), "rb") as file:
...
with open("../results/with_excitability/spikes_h={}.pkl".format(2.0), "rb") as file:
    spktimes = pkl.load(file)
...
rate_df = pd.read_csv("../results/with_excitability/rate_df.csv")
cor_df = pd.read_csv("../results/with_excitability/cor_df.csv")
cor_df["regions"] = cor_df["region_i"] +"\n"+ cor_df["region_j"]


pred_rate_df = pd.read_csv("../results/with_excitability/pred_rates.csv")
...
pred_cor_df = pd.read_csv("../results/with_excitability/pred_cors.csv")
...
plt.savefig("../results/plots/with_excitability.pdf")
plt.show()
