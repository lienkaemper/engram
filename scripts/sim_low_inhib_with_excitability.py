...
dirname = "../results/with_excitability/" + "_".join([p + str(v) for (p,v) in zip(param_df.parameter, param_df.value)])
...
for i in range(trials):
    for k, h in enumerate(h_range):
        ...
        with open("../results/with_excitability/spikes_h={}.pkl".format(h), "wb") as file:
